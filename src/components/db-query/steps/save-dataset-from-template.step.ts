 ...
 */
@step(STEP_SAVE_FROM_TEMPLATE)
export class SaveDatasetFromTemplateStep implements IWorkflowStep<
  unknown,
  TemplateOut
> {
  constructor(
  ...
  async execute({inputData}: WorkflowStepCtx): Promise<TemplateOut> {
