...
import {getDbQueryConfig, type MastraRc} from '../../db-query/steps/_helpers';
import type {IVisualizer} from '../types';

export const DEFAULT_CHART_TYPE = 'bar';
export const STEP_GET_DATASET_DATA = 'get-dataset-data';
export const STEP_SELECT_VISUALISATION = 'select-visualisation';
export const STEP_CALL_QUERY_GENERATION = 'call-query-generation';
export const STEP_RENDER_VISUALIZATION = 'render-visualization';
