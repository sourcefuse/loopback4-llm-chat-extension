...
export const DB_QUERY_NODE_BY_KEY: Record<string, new () => IGraphNode> = {
  ...
  [DbQueryNodes.SemanticValidator]: SemanticValidatorNode,
  [DbQueryNodes.SqlGeneration]: SqlGenerationNode,
  [DbQueryNodes.SyntacticValidator]: SyntacticValidatorNode,
